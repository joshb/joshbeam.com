<?php
	...
	print_html_header("Tutorial - Introduction to Software-based Rendering: Triangle Rasterization");
?>
...
Rasterizer::DrawSpan(const Span &amp;span, int y)
{
	...
	<ul>
		<li><strong><a href="triangleraster-1.tar.gz">triangleraster-1.tar.gz</a> (source tarball)</strong></li>
		<ul>
