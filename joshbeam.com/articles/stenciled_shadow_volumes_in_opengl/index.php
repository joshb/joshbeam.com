<?php
	...
	print_html_header("Tutorial - Stenciled Shadow Volumes in OpenGL");
?>
	...
	<ul>
		<li><strong><a href="shadowvolumes-2.tar.gz">shadowvolumes-2.tar.gz</a> (source tarball)</strong></li>
		<ul>
